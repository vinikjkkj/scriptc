...
Base main `9c3534a9`. Worktree `<blocks>\wrtc`, lab `<blocks>\wrtc-lab`, tmp `<blocks>\wrtc-tmp`.
Toolchain verified: `zig 0.16.0`, PATH node `v22.18.0`, oracle node `v25.9.0`
(`<home>/AppData/Local/nvm/v25.9.0/node`).

## Stage 0 — verifying the brief

Source of truth read:
`<zapo-work>/caches/bridge-provenance/250f9af5229a545eec28ddbd3e8774a397cdb0bb/packages/voip/src/relay/WaSctpRelay.ts`
