...
const src = readFileSync("<blocks>/restapi/lab/app2/zapo-rest.ts", "utf8");
const cov = JSON.parse(readFileSync("<blocks>/restapi/lab/coverage.json", "utf8"));
...
writeFileSync("<blocks>/restapi/lab/API.md", out.join("\n"));
