...
# app directory.  Every arm uses <zapo-work>/zapobench-artifacts/app; arms
...
export SCRIPTC_PROVENANCE_CACHE='<blocks>\zapobench\'"$CDIR"'\prov'
export SCRIPTC_TRAP_TRACE=1
mkdir -p "<blocks>/zapobench/$CDIR/prov"
