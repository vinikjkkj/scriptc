...
const JS = process.argv[2] ?? "<zapo-work>/app/node_modules/zapo-js/spec/proto/index.js";
const DTS = process.argv[3] ?? "<zapo-work>/app/node_modules/zapo-js/spec/proto/index.d.ts";
