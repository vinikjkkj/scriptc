...
// ONE edit against pkgs/voip/media/mlow-codec.ts: the dynamic
// import('libmlow-wasm') is replaced by a local function of the SAME type.
// Everything else is byte-identical. If the SC2009 sites survive, the
// import is not what stops this module.
declare function stubMlowModule(): Promise<unknown>
