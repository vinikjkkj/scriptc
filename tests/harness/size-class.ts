 ...
 * trees in the same shell (<blocks>/dynacc/lab/size/measure.mjs); the
 ...
 * options (<blocks>/utf16len/lab/size/measure.mjs):
 *
 ...
 * one under <zapo-work>/tools/zig. They are not the same compiler --
